...
### Висновок:
Я навчився створювати масиви, дізнався про одновимірну і багатовимірну індексацію, вияснив різницю між python і numpy типами даних, навчився конкатенувати та сплітити масиви, робити зрізи та дослідив що таке numpy views.